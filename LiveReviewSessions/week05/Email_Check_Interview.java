...
public class Email_Check_Interview {

    public static void main(String[] args) {


        Scanner scan = new Scanner(System.in);
        System.out.println("Please enter your valid email adress:");

        String email = scan.nextLine();
        int signIndex = email.indexOf("@");
        int signindexOf2 = email.indexOf(".");
        int signindexOf3 = email.indexOf(".co");

        if(email.contains("@")&&email.contains(".")&&signIndex>0){

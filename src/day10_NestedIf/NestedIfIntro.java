...
public class NestedIfIntro {
    ...
    public static void main(String[] args) {
        ...
        if (score >= 0 && score <= 100) { // İf the score is valid
        ...
        } else {// if the score is not valid or invalid
        ...
        if (number >= 1 && number <= 7) { // if the number is a valid number (1~7)
            ...
            int number2 = 25;
            // 1<= number <= 7
            if (number >= 1 && number <= 7) {//>>>>> if the number is valid number (1~~7) pre-condition
                // Nested if
                if (number == 1) {
                    System.out.println("Monday");
                } else if (number == 2) {

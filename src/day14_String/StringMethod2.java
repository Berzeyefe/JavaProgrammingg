...
public class StringMethod2 {
    ...
    public static void main(String[] args) {
        ...
        String str2 = str.replace("Java" ,"Python");// "Phyton is fun, I love learning Phyton."
        ...
        String sentence2 = sentence.replace("Python" , "").replace("  ", "  " );//J"ava Java
                                                                                                  //C# C# C++ C++"
        System.out.println("sentence2 = " + sentence2);

        sentence2 = sentence.replace("Python" , "");
